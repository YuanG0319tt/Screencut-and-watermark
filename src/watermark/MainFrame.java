...
public class MainFrame extends JFrame {
	...
	private String toward[] = { "右下", "左下", "右上", "左上", "正中", "左上->右下",
			"左下->右下" };//添加文字的位置
	private String fontstyle[] = {"普通","粗体","斜体","粗体&斜体"};//字体样式
	...
	private String fontcolor[] = {"蓝色","青色","绿色","红色","灰色","深灰色","浅灰色",
			"洋红色","桔黄色","粉红色","黄色","黑色","白色"};//添加字体颜色
	private String scales[] = {"不缩放", "25%", "50%", "75%","125%","150%","175%","200%"};//缩放比例
	private float imgScales[] = {1.0f, 0.25f, 0.5f, 0.75f, 1.25f, 1.5f, 1.75f, 2.0f};//缩放比例
	private Color colors[] = {Color.blue, Color.cyan, Color.green, Color.red, Color.gray,
			...
			Color.yellow, Color.black, Color.white};//添加文字颜色
	private JComboBox fontCB, towardCB, fontstyleCB, fontcolorCB, scaleCB;//下拉菜单式的复选框：选择字体，文字位置，字体样式，字体颜色，缩放比例
	private JTextField filepathTF, savepathTF, markTF, fontsizeTF;//单行文本框：文件路径，新文件的路径，文字内容，字体大小
	private JSlider alphaSlider;//滑动旋钮
	...
	private MainFrame() {
		// 设置外观
		setUI(UIClassName.systemLookAndFeel);//系统外观
	...
	private JPanel getNorthPanel() {
		...
		panel.setLayout(new GridBagLayout());//网格布局
		...
		gbc.insets = new Insets(5, 10, 5, 10);//上，左，下，右
	...
	private JPanel getCenterPanel() {
		...
		label = new JLabel("添加位置:", JLabel.RIGHT);
		panel.add(label, gbc);
		...
		label = new JLabel("添加颜色:", JLabel.RIGHT);
		panel.add(label, gbc);
		...
		gbc.gridwidth = GridBagConstraints.REMAINDER;
		markTF = new JTextField("请输入需要添加的文字");
	...
	/**
	 * @return 放置将要添加文字的文件路径的JTextField
	 */
	public JTextField getFilepathTF() {
		return filepathTF;
	}
	/**
	 * @return 放置将要添加文字后保存路径的JTextField
	 */
